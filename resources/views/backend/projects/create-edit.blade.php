		                    	...
		                    	<div class="row">
		                    		<div class="col-sm-12">
		                                ...
		                                <div class="form-group">
		                                    ...
		                                    <input type="text" class="form-control" name="investor" id="investor" value="{!! old('investor', @$data->investor) !!}">
		                                </div>
		                                <div class="form-group">
		                                    <label>Địa chỉ</label>
		                                ...
		                                <div class="form-group">
		                                    ...
		                                    <input type="text" class="form-control" name="acreage" id="acreage" value="{!! old('acreage', @$data->acreage) !!}">
		                                </div>
		                                <div class="form-group">
		                                    <label>Thời gian thi công</label>
		                                    <input type="text" class="form-control" name="time_project" id="time_project" value="{!! old('time_project', @$data->time_project) !!}">
		                                </div>
		                                @if(isUpdate(@$module['action']))
		                                ...
		                                <div class="form-group" style="display: none;">
		                                	<label for="">Mô tả ngắn dự án</label>
