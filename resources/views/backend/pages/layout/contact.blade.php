							...
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" value="{{ @$content->info->phone }}"name="content[info][phone]">
									</div>
									<div class="form-group">
										<label for="">Email</label>
										<input type="text" class="form-control" value="{{ @$content->info->email }}"name="content[info][email]">
									</div>
									<div class="form-group">
										<label for="">Facebook</label>
										<input type="text" class="form-control" value="{{ @$content->info->facebook }}"name="content[info][facebook]">
									</div>
									<div class="form-group">
										<label for="">Zalo</label>
										<input type="text" class="form-control" value="{{ @$content->info->zalo }}"name="content[info][zalo]">
									</div>
									<div class="form-group">
										<label for="">Mô tả</label>
										<textarea class="form-control" rows="5" name="content[info][desc_pages]">{{ @$content->info->desc_pages }}</textarea>
									</div>
								</div>
							</div>
			            </div>
