...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $category = Categories::where('type', 'project_category')->get();
        $data['data'] = $category;
    ...
    public function store(Request $request)
    {
        ...
        $post_check_sulg = Categories::where('slug', $request->slug)->where('type', 'project_category')->first();
    ...
    public function edit($id)
    {
        ...
        $data['categories'] = Categories::where('id', '!=', $id)->where('type', 'project_category')->get();
